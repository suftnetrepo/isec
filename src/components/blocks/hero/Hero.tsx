              ...
              <div className="row gx-md-8 gx-xl-12 gy-10 align-items-center text-center text-lg-start">
                <div className="col-lg-6">
                  <h1 className="display-2 mb-4 me-xl-5 me-xxl-0" style={slideInDownAnimate("900ms")}>
                    Protecting Lives & <span className="text-gradient gradient-1">Assets</span> Through Excellence
                  </h1>

                  <p className="lead fs-23 lh-sm mb-7 pe-xxl-15" style={slideInDownAnimate("1200ms")}>
                   We specialize in design, installation and commissioning of fire life safety and security systems across England.
                  </p>
                  <div style={slideInDownAnimate("1500ms")}>
                    <NextLink title="Get In Touch" href="/contact" className="btn btn-lg btn-gradient gradient-1 rounded" />
                  </div>
                </div>
